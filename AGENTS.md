...
- `/youtube-content-pipeline` — a complete YouTube or YouTube Shorts release pipeline: staged plan, hybrid Gemini Omni + self-hosted ComfyUI LTX-2.3 scene generation, Gemini TTS, HyperFrames edit, captions, thumbnail, metadata, render/package, and optional private-first YouTube Data API upload.
